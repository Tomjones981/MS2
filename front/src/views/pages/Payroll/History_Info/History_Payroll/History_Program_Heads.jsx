...
const History_Program_Heads = () => {
    ...
    const handleDateChange = (dates) => {
      ...
      const fetchPayrollHistory = async (e) => {
        ...
        try {
          const response = await axiosClient.get('/get-payroll-history/program/heads', {
            params: {
              date_from: dateFrom,
              date_to: dateTo,
            },
    ...
    const buttons = [
        ...
        { label: 'Part Time', route: '/payroll/history/part/time', icon: <FaUserClock />, color: 'bg-gray-600 hover:bg-gray-500 text-gray-200' },
        ...
        { label: 'Program Heads', route: '/payroll/history/program/heads', icon: <FaUserFriends />, color: 'bg-gray-200 hover:bg-gray-300 text-gray-800' },
    ];
...
export default History_Program_Heads;
