...
const History_PT_Regular = () => {
    ...
    const handleDateChange = (dates) => {
      ...
      const fetchPayrollHistory = async (e) => {
        ...
        try {
          const response = await axiosClient.get('/get-payroll-history/part/time/regular', {
            params: {
              date_from: dateFrom,
              date_to: dateTo,
            },
    ...
    const buttons = [
        ...
        { label: 'PT-Regular', route: '/payroll/history/parttime/regular', icon: <FaUserPlus />, color: 'bg-gray-200 hover:bg-gray-300 text-gray-800' },
...
export default History_PT_Regular;
