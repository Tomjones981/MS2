...
const Program_Heads_History = () => {
    ...
    const printTable = () => {
        ...
        printWindow.document.write('<h2>Program Heads  Payroll</h2>'); 
    ...
    const buttons = [
        ...
        { label: 'Program Heads', route: '/admin/history/program/heads', icon: <FaUserFriends />, color: 'bg-gray-200 hover:bg-gray-300 text-gray-800' },
    ];
...
export default Program_Heads_History;
