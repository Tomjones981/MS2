...
const Part_Time_History = () => {
    ...
    const fetchData = async (dateFrom, dateTo) => {
        setLoading(true); 
        try {
            const response = await axiosClient.post('/get-payroll-history/part/time', {
                date_from: dateFrom,
                date_to: dateTo,
            });
    ...
    const printTable = () => {
        ...
        printWindow.document.write('<h2>Part Time Payroll  </h2>'); 
    ...
    const buttons = [
        ...
        { label: 'Part Time', route: '/admin/history/part/time', icon: <FaUserClock />, color: 'bg-gray-200 hover:bg-gray-300 text-gray-800' },
...
export default Part_Time_History;
