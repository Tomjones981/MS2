            ...
            <div className='mt-2 w-full p-5 bg-white border border-gray-200 rounded-lg  dark:bg-gray-800 dark:border-gray-700'>
                        ...
                        {openMenu && (
                            <div className=' '>
                                <div className='absolute right-[5rem] mt-10  flex gap-5 w-[30rem] bg-white dark:bg-gray-800 rounded-lg -lg p-2 z-10'>
                                    <button  type='button'  onClick={() => handleCliCkReportView(true)}  className="font-light flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg -md hover:bg-blue-700 transition">
                                        Reports
                                    </button>
                        ...
                        <div className="max-h-[37rem] overflow-y-auto rounded-lg  border border-gray-200 dark:border-gray-700">
                            <table className="w-full">
                                <thead className='text-gray-800 sticky -top-1 bg-gray-50 dark:bg-gray-200 border-b-2 border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-gray-200'>
                                    <tr className=""> 
                                        <th className="font-light p-3 text-sm font-semibold tracking-wide text-left">Full Name</th> 
                                        <th className="font-light p-3 text-sm font-semibold tracking-wide text-left">Birthday</th>
                                        <th className="font-light p-3 text-sm font-semibold tracking-wide text-left">Barangay</th>
                                        <th className="font-light w-24 p-3 text-sm font-semibold tracking-wide text-left">Gender </th>
                                        <th className="font-light w-24 p-3 text-sm font-semibold tracking-wide text-left">Year Old</th>
                                        {/* <th className="font-light w-24 p-3 text-sm font-semibold tracking-wide text-left">PWD</th> */}
                                        <th className="font-light w-32 p-3 text-sm font-semibold tracking-wide text-center">Action</th>
                                    </tr>
                                </thead>
                                <tbody className='divide-y divide-gray-100 dark:divide-gray-700 dark:bg-gray-800'>
                                    {loading ? (
                                        ...
                                        <tr key={cdc.id} className="bg-white dark:bg-gray-800"> 
                                            <td className="font-light p-3 text-sm text-gray-700   dark:text-gray-200">{cdc.last_name}, {cdc.first_name} {cdc.middle_name}</td> 
                                            <td className="font-light p-3 text-sm text-gray-700 whitespace-nowrap dark:text-gray-200">{cdc.birthday}</td>
                                            <td className="font-light p-3 text-sm text-gray-700 whitespace-nowrap dark:text-gray-200">{cdc.barangay}</td>
                                            <td className="font-light p-3 text-sm text-gray-700 whitespace-nowrap">  
                                                <span className="font-light p-1.5 text-xs font-medium uppercase tracking-wider text-green-800 bg-green-200 rounded-lg bg-opacity-50 dark:text-gray-200 dark:bg-green-600">
                                                {cdc.M === '/' || !cdc.F ? 'Male' : cdc.F === '/' || !cdc.M ? 'Female' : ''}
                                                </span>
                                                
                                            </td>
                                            <td className="font-light p-3 text-sm text-gray-700 whitespace-nowrap dark:text-gray-200 text-center">
                ...
                <Modal show={openCreateModal} size='2xl' onClose={() => setOpenCreateModal(false)}>
                    <Modal.Header className=''>
                        <h1 className='font-light'>Add CDC </h1>
                    </Modal.Header>
                    <Modal.Body>
                        <div>
                            <form onSubmit={handleSubmit}> 
                                <div className='grid grid-cols-1 gap-2'>
                                    <div>
                                        <label htmlFor="first_name" className="font-light mt-2 block mb-1  text-md font-medium text-gray-900 dark:text-white">First Name</label>
                                        <input type="text" name="first_name" value={formData.first_name} onChange={handleChange} className="font-light bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" ......"    />
                                    </div>
                                    <div>
                                        <label htmlFor="middle_name" className="font-light mt-2 block mb-1  text-md font-medium text-gray-900 dark:text-white">Middle Name</label>
                                        <input type="text" name="middle_name" value={formData.middle_name} onChange={handleChange} className="font-light bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" ......"    />
                                    </div>
                                    <div>
                                        <label htmlFor="last_name" className="font-light mt-2 block mb-1  text-md font-medium text-gray-900 dark:text-white">Last Name</label>
                                ...
                                <div className='grid grid-cols-2 gap-5'> 
                                    <div>
                                        <label htmlFor="birthday" className="font-light mt-2 block  text-md font-medium text-gray-900 dark:text-white">Birth Date</label>
                                        <DatePicker  format="YYYY-MM-DD" name="birthday" onChange={handleDateChange}  className='font-light bg-gray-50 h-9 mt-1 text-gray-700 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200' required/>
                                    </div> 
                                    <div className='mt-9'> 
                                        <select name="barangay" value={formData.barangay} onChange={handleChange} className='h-9 w-[10.3rem] font-light bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' required>
                                            <option value="" className='font-light'>Select Barangay</option>
                ...
                <Modal show={openImportModal} size='md' onClose={() => setOpenImportModal(false)}>
                    <Modal.Header>
                        <h1 className='font-light'>Import CDC File</h1>
                    </Modal.Header>
                    <Modal.Body>
                        <div className="flex flex-col space-y-4">
                            <input type="file" accept=".xlsx, .csv" onChange={handleFileChange} className="border p-2 rounded dark:border-gray-500" />
                            {/* <button onClick={handleImportSubmit} className="bg-indigo-600 text-white px-4 py-2 rounded-lg -md hover:bg-indigo-700 transition" >
                                Import File
                            </button> */}
                ...
                <Modal show={openViewModal} size='lg' onClose={() => setOpenViewModal(false)}>
                    <Modal.Header>
                        <h1 className='font-light text-lg font-bold text-gray-800 dark:text-gray-200'>Personal Information</h1>
                    </Modal.Header>
                    <Modal.Body>
                        {selectedCdcInfo && (
                            <div className="bg-gray-100 rounded-lg p-6 -md dark:bg-gray-700 border border-gray-300 dark:border-gray-500">
                                <div className="flex flex-col gap-4"> 
                                    <div className="border-b pb-2 dark:border-gray-500">
                                        ...
                                        <p className="font-light font-semibold text-gray-800 dark:text-gray-200">{selectedCdcInfo.id}</p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 border-b pb-2 dark:border-gray-500">
                                        <div>
                                            ...
                                            <p className="font-light font-semibold text-gray-800 dark:text-gray-200">{selectedCdcInfo.birthday}</p>
                                        </div>
                                        <div>
                                            <p className="font-light text-sm text-gray-600 dark:text-gray-200">Barangay</p>
                                            <p className="font-light font-semibold text-gray-800 dark:text-gray-200">{selectedCdcInfo.barangay}</p>
                                        </div>
                                    </div>
                    ...
                    <Modal.Footer className='flex justify-end'>
                        ...
                        <Button className="font-light text-white rounded-md   transition-all  ">
                            Edit
                        </Button>
                    </Modal.Footer>
                </Modal>
