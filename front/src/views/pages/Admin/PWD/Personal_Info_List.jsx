            ...
            <div className='mt-2 w-full p-5 bg-white border border-gray-200 rounded-lg  dark:bg-gray-800 dark:border-gray-700'>
                        ...
                        {openMenu && (
                            <div className=' '>
                                <div className='absolute right-[5rem] mt-10  flex gap-5 w-[30rem] bg-white dark:bg-gray-800 rounded-lg -lg p-2 z-10'>
                                    <button  type='button' onClick={() => setOpenViewReportModal(true)} className="font-light flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg -md hover:bg-blue-700 transition">
                                        Reports
                                    </button>
                ...
                <div className='grid grid-cols-10 mt-6 mb-2 gap-4 '> 
                    <div className='col-span-7'> 
                        <select name={barangayFilter}  onChange={handleBarangayChange}  className='h-9 font-light bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'>
                            <option value="" className='font-light'>All</option>
                            <option value="AWANG" className='font-light '>Awang</option> 
                            <option value="BAGOCBOC" className='font-light '>Bagocboc</option> 
                            <option value="BARRA" className='font-light '>Barra</option> 
                            <option value="BONBON" className='font-light '>Bonbon</option> 
                            <option value="CAUYONAN" className='font-light '>Cauyonan</option> 
                            <option value="IGPIT" className='font-light '>Igpit</option> 
                            <option value="L-BONBON" className='font-light '>Luyong Bonbon</option> 
                            <option value="LIMONDA" className='font-light '>Limonda</option> 
                            <option value="MALANANG" className='font-light '>Malanang</option> 
                            <option value="NANGCAON" className='font-light '>Nangcaon</option> 
                            <option value="PATAG" className='font-light '>Patag</option> 
                            <option value="POBLACION" className='font-light '>Poblacion</option> 
                            <option value="TINGALAN" className='font-light '>Tingalan</option> 
                            <option value="TABOC" className='font-light '>Taboc</option> 
                        </select>
                    </div>
                        ...
                        <div className="max-h-[37rem] overflow-y-auto rounded-lg  border border-gray-200 dark:border-gray-700">
                            <table className="w-full ">
                                <thead className='text-gray-800 sticky top-0 bg-gray-50 dark:bg-gray-200 border-b-2 border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-gray-200'>
                                    <tr className="">
                                        <th className="font-light w-20 p-3 text-sm font-semibold tracking-wide text-left">ID Number</th>
                                        <th className="font-light w-20 p-3 text-sm font-semibold tracking-wide text-left">Name</th>
                                        <th className="font-light w-20 p-3 text-sm font-semibold tracking-wide text-left">Barangay</th>
                                        <th className="font-light w-20 p-3 text-sm font-semibold tracking-wide text-left">Disability</th>
                                        {/* <th className="font-light w-20 p-3 text-sm font-semibold tracking-wide text-left">Birthday</th>
                                        <th className="font-light w-20 p-3 text-sm font-semibold tracking-wide text-left">Sex</th>
                                        <th className="font-light w-20 p-3 text-sm font-semibold tracking-wide text-left">Blood Type</th>
                                        <th className="font-light w-20 p-3 text-sm font-semibold tracking-wide text-left">Age</th> */}
                                        <th className="font-light w-20 p-3 text-sm font-semibold tracking-wide text-left">Actions</th>
                                    </tr>
                                </thead>
                                ...
                                {loading ? (
                                        ...
                                        paginatedData.map((info) => (
                                            ...
                                            <td className="font-light p-3 text-sm text-blue-500 font-bold whitespace-nowrap hover:underline dark:text-gray-200">{info.id_number || "N/A"} </td>
                                                <td className="font-light p-3 text-sm text-gray-700 whitespace-nowrap dark:text-gray-200   ">{info.name || "N/A"}</td>
                                                <td className="font-light p-3 text-sm text-gray-700 whitespace-nowrap dark:text-gray-200  ">{info.barangay || "N/A"}</td>
                                                <td className="font-light p-3 text-sm text-gray-700 whitespace-nowrap dark:text-gray-200   ">{info.disability || "N/A"}</td>
                                                {/* <td className="font-light p-3 text-sm text-gray-700 whitespace-nowrap dark:text-gray-200  ">{info.birthday || "N/A"}</td>
                                                <td className="font-light p-3 text-sm text-gray-700 whitespace-nowrap dark:text-gray-200">{info.sex || "N/A"}</td>
                                                <td className="font-light p-3 text-sm text-gray-700 whitespace-nowrap dark:text-gray-200">{info.blood_type || "N/A"}</td>
                                                <td className="font-light p-3 text-sm text-gray-700 whitespace-nowrap dark:text-gray-200">{info.age || "N/A"}</td> */}
                        ...
                        <div>
                            <form onSubmit={handleSubmit}>
                                <div className='grid grid-cols-2 gap-5'> 
                                    <div>
                                        <label htmlFor="id_number" className="font-light mt-2 block mb-1  text-md font-medium text-gray-900 dark:text-white">Id Number</label>
                                        <input type="text" name="id_number" value={formData.id_number} onChange={handleInputChange} className="font-light bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" ......"    />
                                    </div>
                                    <div>
                                        <label htmlFor="name" className="font-light mt-2 block mb-1  text-md font-medium text-gray-900 dark:text-white">Full Name</label>
                                        <input type="text" name="name" value={formData.name} onChange={handleInputChange} className="font-light bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" ......"    />
                                    </div>
                                    <div>
                                        <label htmlFor="barangay" className="font-light mt-2 block mb-1  text-md font-medium text-gray-900 dark:text-white">Barangay</label>
                                        <select name="barangay" value={formData.barangay} onChange={handleInputChange} className='font-light bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' required>
                                            <option value="">Select Barangay</option>
                                            <option value="AWANG" className='font-light '>Awang</option> 
                                            <option value="BAGOCBOC" className='font-light '>Bagocboc</option> 
                                            <option value="BONBON" className='font-light '>Bonbon</option> 
                                            <option value="CAUYONAN" className='font-light '>Cauyunan</option> 
                                            <option value="IGPIT" className='font-light '>Igpit</option> 
                                            <option value="L-BONBON" className='font-light '>Luyong Bonbon</option> 
                                            <option value="LIMUNDA" className='font-light '>Limunda</option> 
                                            <option value="MALANANG" className='font-light '>Malanang</option> 
                                            <option value="NANGCAON" className='font-light '>Nangcaon</option> 
                                            <option value="PATAG" className='font-light '>Patag</option> 
                                            <option value="POBLACION" className='font-light '>Poblacion</option> 
                                    ...
                                    <div>
                                        <label htmlFor="disability" className="font-light mt-2 block mb-1  text-md font-medium text-gray-900 dark:text-white">Disability</label>
                                        <input type="text" name="disability" value={formData.disability} onChange={handleInputChange} className="font-light bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" ......"    />
                                    </div>
                                    <div>
                                        <label htmlFor="birthday" className="font-light mt-2 block mb-1  text-md font-medium text-gray-900 dark:text-white">Birthday</label>
                                        <input type="text" name="birthday" value={formData.birthday} onChange={handleInputChange} className="font-light bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" ......"    />
                                    </div>
                                    <div>
                                        <label htmlFor="sex" className="font-light mt-2 block mb-1  text-md font-medium text-gray-900 dark:text-white">Barangay</label>
                                    ...
                                    <div>
                                        <label htmlFor="blood_type" className="font-light mt-2 block mb-1  text-md font-medium text-gray-900 dark:text-white">Barangay</label>
                                        <select name="blood_type"  value={formData.blood_type} onChange={handleInputChange} className='font-light bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' required>
                                            <option value="">Select Blood Type</option> 
                                            <option value="A" className='font-light '>A</option>  
                                            <option value="A+" className='font-light '>A+</option>  
                                            <option value="A-" className='font-light '>A-</option>  
                                            <option value="AB" className='font-light '>AB</option> 
                                            <option value="B" className='font-light '>B</option>  
                                            <option value="B+" className='font-light '>B+</option>  
                                            <option value="B-" className='font-light '>B-</option>  
                                            <option value="AB+" className='font-light '>AB+</option>    
                                            <option value="AB-" className='font-light '>AB-</option>    
                                            <option value="O" className='font-light '>O</option>    
                                            <option value="O+" className='font-light '>O+</option> 
                                            <option value="O-" className='font-light '>O-</option>      
                                        </select>
                                    </div>
                                    ...
                                    <div className="flex justify-end mt-4">
                                        <button type="submit" className="px-4 py-2 bg-green-600 text-white rounded-lg -md hover:bg-green-700 transition">
                                            Submit
                                        </button>
                                    </div>
                ...
                <Modal show={openImportModal} size='md' onClose={() => setOpenImportModal(false)}>
                    <Modal.Header>
                        <h1 className='font-light'>Import PWD File</h1>
                    </Modal.Header>
                    <Modal.Body>
                ...
                <Modal show={openViewModal} size="lg" onClose={() => setOpenViewModal(false)}>
                    <Modal.Header>
                        <h1 className="font-light text-lg font-bold text-gray-800 dark:text-gray-200">
                            ...
                            <div className="bg-gray-100 rounded-lg p-6 -md dark:bg-gray-700 border border-gray-300 dark:border-gray-500">
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="border-b pb-2 dark:border-gray-500">
                                        <p className="font-light text-sm text-gray-600 dark:text-gray-200">ID Number</p>
                                        <p className="font-light font-semibold text-gray-800 dark:text-gray-200">{selectedPersonalInfo.id_number}</p>
                                    </div>

                                    <div className="grid grid-cols-1 gap-4 border-b pb-2 dark:border-gray-500">
                                        <div>
                                            <p className="font-light text-sm text-gray-600 dark:text-gray-200">Full Name</p>
                                            <p className="font-light font-semibold text-gray-800 dark:text-gray-200">{selectedPersonalInfo.name}</p>
                                        </div>
                                        <div>
                                            <p className="font-light text-sm text-gray-600 dark:text-gray-200">Disability</p>
                                            <p className="font-light font-semibold text-gray-800 dark:text-gray-200">{selectedPersonalInfo.disability || "None"}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 border-b pb-2 dark:border-gray-500">
                                        ...
                                        <div>
                                            <p className="font-light text-sm text-gray-600 dark:text-gray-200">Birthday</p>
                                            <p className="font-light font-semibold text-gray-800 dark:text-gray-200">{selectedPersonalInfo.birthday}</p>
                                        </div>
                                        <div>
                                            <p className="font-light text-sm text-gray-600 dark:text-gray-200">Barangay</p>
                                            <p className="font-light font-semibold text-gray-800 dark:text-gray-200">{selectedPersonalInfo.barangay}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <p className="font-light font-semibold text-gray-800 dark:text-gray-200">{selectedPersonalInfo.sex}</p>
                                        </div>
                                        <div>
                                            <p className="font-light text-sm text-gray-600 dark:text-gray-200">Blood Type</p>
                                            <p className="font-light font-semibold text-gray-800 dark:text-gray-200">{selectedPersonalInfo.blood_type}</p>
                                        </div>
                                        <div>
                                            <p className="font-light text-sm text-gray-600 dark:text-gray-200">Age</p>
                                            <p className="font-light font-semibold text-gray-800 dark:text-gray-200">{selectedPersonalInfo.age}</p>
                    ...
                    <Modal.Footer className="flex justify-end">
                        ...
                        <Button  onClick={() => handleEditClick(selectedPersonalInfo)} className="font-light   text-white rounded-md   transition-all ">
                            Edit
                        </Button>
                    </Modal.Footer>
                </Modal>
                ...
                <Modal show={openEditModal} size='xl' onClose={() => setOpenEditModal(false)}>
                    <Modal.Header>
                        <h1 className='font-light'>Edit</h1>
                    </Modal.Header>
                    <Modal.Body>
                        <div>
                ...
                <Modal show={openViewReportModal}  size='5xl' onClose={() => setOpenViewReportModal(false)}>
                    <Modal.Header>
                        <h1 className="text-2xl font-bold    text-gray-600 dark:text-gray-200 font-light">
                            PWD Barangay Counts
                        </h1>
                    </Modal.Header> 
                    <Modal.Body>
