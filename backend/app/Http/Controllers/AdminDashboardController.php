...
class AdminDashboardController extends Controller
{
    ...
    public function getTotalPartTimeRegularFaculties()
    { 
        $totalPartTimeRegularFaculties = Employment::where('employment_type', 'part_time_regular')->count();
 
        return response()->json([
            'total_part_time_regular_faculties' => $totalPartTimeRegularFaculties
        ]);
    }
